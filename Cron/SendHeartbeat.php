<?php
/**
 * Daily heartbeat cron for Panth_SaleFilterHyva. Skips if Panth_Core is
...
namespace Panth\SaleFilterHyva\Cron;

use Magento\Framework\Module\Manager as ModuleManager;
use Panth\SaleFilterHyva\Service\InstallReporter;
