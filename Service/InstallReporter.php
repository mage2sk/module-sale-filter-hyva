<?php
/**
 * Standalone install + heartbeat reporter for Panth_SaleFilterHyva.
 *
...
namespace Panth\SaleFilterHyva\Service;
...
class InstallReporter
{
    ...
    public const MAGENTO_MODULE = 'Panth_SaleFilterHyva';

    /** Composer package name reported to the receiver. */
    public const COMPOSER_PACKAGE = 'mage2kishan/module-sale-filter-hyva';
